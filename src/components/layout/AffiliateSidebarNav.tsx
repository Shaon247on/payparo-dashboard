  ...
  return (
    <div className="flex flex-col h-full bg-[#13151e] border-r border-white/5 w-full">
      ...
      <div className="flex items-center gap-2 px-6 py-5 border-b border-white/5">
        <div className="w-8 h-8 rounded-lg bg-[#00d4aa] flex items-center justify-center font-bold text-black text-sm">
          PP
        </div>
        <div className="flex flex-col">
          <span className="text-white font-bold text-sm tracking-wide leading-none">PayParo</span>
          <span className="text-[#00d4aa] text-[10px] font-semibold tracking-wider uppercase mt-1">
            Affiliate Portal
          </span>
        </div>
      </div>
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "bg-[#00d4aa]/10 text-[#00d4aa] border-[#00d4aa]/10"
            ...
            >
              <Icon
                className={cn(
                  ...
                  isActive ? "text-[#00d4aa]" : "text-white/30 group-hover:text-white/60"
                )}
              />
              {item.label}
            </Link>
